...
- [ ] Definir persistencia real de la acción "Colocar"
...
- [ ] Consolidar el refactor de transacciones y validaciones en la documentación técnica
- [ ] Revisar seeder con IDs asumidos
- [ ] Documentar refactors técnicos recientes en memoria
